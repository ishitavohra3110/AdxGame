 ...
 */
public class SeventhAgent extends ThirtyDaysThirtyCampaignsAgent {

  public SeventhAgent(String host, int port) {
    super(host, port);
  }
  ...
  public static void main(String[] args) {
    SeventhAgent agent = new SeventhAgent("localhost", 9898);
